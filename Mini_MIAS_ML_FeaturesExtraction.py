...
def Testing_ML_Models_Biclass_FOF(Model, Technique, All_images, All_labels):
    ...
    Machine_learning_config(Dataframe_concat, Dataframe_save_mias, Dataframe_save_mias_folder, Column_names, Model, Technique, Technique_name_normal, Labels_biclass, Biclass_Data_CSV, Biclass_Data_Model)
...
def Testing_ML_Models_Multiclass_FOF(Model, Technique, All_images, ALL_labels):
    ...
    Machine_learning_config(Dataframe_concat, Dataframe_save_mias, Dataframe_save_mias_folder, Column_names, Model, Technique, Technique_name_normal, Labels_triclass, Multiclass_Data_CSV, Multiclass_Data_Model)
...
def Testing_ML_Models_Multiclass_GLCM(Model, Technique, All_images, ALL_labels):
    ...
    # * Save dataframe in the folder given
    Dataframe_save_mias_name = 'Multiclass' + '_Dataframe_' + 'GLCM_' + str(Technique)  + '.csv'
    Dataframe_save_mias_folder = os.path.join(Multiclass_Data_CSV, Dataframe_save_mias_name)
